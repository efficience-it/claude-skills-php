---
name: review
description: "Revue de code standardisée pour projet PHP/Symfony. Analyse le diff git staged ou un fichier donné. Détecte les violations d'architecture, failles de sécurité, tests manquants, et violations PSR-12. Utiliser quand un développeur veut une revue avant commit ou push."
---
...
Classe chaque remarque par sévérité :

1. **Bloquant** : doit être corrigé avant merge
2. **Important** : devrait être corrigé, risque réel
3. **Suggestion** : amélioration recommandée, pas urgente
...
Si aucun problème n'est trouvé, indique que le code est propre. Ne pas inventer de faux positifs.
